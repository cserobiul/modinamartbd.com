<div class="sticky-footer sticky-content fix-bottom">
    ...
    <div class="cart-dropdown dir-up">
        <a href="{{ route('cartPage') }}" class="sticky-link">
        ...
        <div class="dropdown-box">
            ...
            <div class="cart-action">
                <a href="{{ route('cartPage') }}" class="btn btn-dark btn-outline btn-rounded">View Cart</a>
    ...
    <div class="header-search hs-toggle dir-up">
        ...
        <form action="{{ route('searchPage') }}" method="get" class="input-wrapper">
            <input type="text" class="form-control" name="keyword" id="keyword" autocomplete="off" placeholder="Search"
                   required />
