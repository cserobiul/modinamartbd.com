                                                            ...
                                                            <div class="product-imgbox">
                                                                <div class="product-front">
                                                                    @if(file_exists(public_path($brand->photo)))
                                                                        <a href="{{ route('brandDetailsSlug',$brand->slug) }}"> <img src="{{ asset($brand->photo) }}" class="img-fluid  customPhoto" alt="product"> </a>
                                                                    @else
                                                                        <a href="{{ route('brandDetailsSlug',$brand->slug) }}"> <img src="{{ asset('assets/images/no-image.png') }}" class="img-fluid  customPhoto" alt="product"> </a>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="detail-title">
                                                                    <div class="detail-left">
                                                                        <a href="{{ route('brandDetailsSlug',$brand->slug) }}">
                                                                            <h6 class="price-title"> {{ \App\Models\Settings::unicodeName($brand->brand_name) }} </h6>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            </div>
