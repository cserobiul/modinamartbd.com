...
@section('title', \App\Models\Settings::unicodeName($product->name))
                ...
                <div class="breadcrumb-contain">
                    <div>
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-angle-double-right"></i></li>
                            <li>{{ \App\Models\Settings::unicodeName($product->name) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="product-slick">
                                        @if(count($productPhotos) > 0)
                                            @foreach($productPhotos as $photo)
                                                <div><img src="{{ asset($photo->photo) }}" alt="{{ $photo->name }}" class="img-fluid  image_zoom_cls-{{ $photo->id }}"></div>
                                            @endforeach
                                        @else
                                            <div><img src="{{ asset($product->photo) }}" alt="{{ $product->name }}" class="img-fluid  image_zoom_cls-{{ $product->id }}"></div>
                                        @endif
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right">
                                        <div class="pro-group">
                                            <h2>{{ \App\Models\Settings::unicodeName($product->name) }}</h2>
                                            <ul class="pro-price">
                                                @if($product->discount_amount > 0)
                                                    <li>৳ {{ $product->sale_price }}</li>
                                                    <li><span>mrp ৳ {{ $product->sale_price + $product->discount_amount }}</span></li>
                                        ...
                                        <div id="selectSize" class="pro-group addeffect-section product-description border-product mb-0">
                                            <h6 class="product-title size-text">Category: <span>
                                                    <a href="{{ route('categoryDetailsSlug',$product->category->slug) }}">{{ \App\Models\Settings::unicodeName($product->category->name) }}</a>
                                                </span></h6>
                                            <h6 class="product-title size-text">Brand: <span>
                                                    <a href="{{ route('brandDetailsSlug',$product->brand->slug) }}">{{ \App\Models\Settings::unicodeName($product->brand->brand_name) }}</a>
                                                </span></h6>
                                           <h6 class="product-title size-text">Point:
                                                    <span>{{ $product->point }}</span>
                                           </h6>
                                            <div class="qty-box">
                                                <div class="input-group">
                                                    <button class="qty-minus"></button>
                                                    <input id="qty" class="qty-adj form-control" type="number" value="1" min="1" max="1000" step="1" required/>
                                                    <button class="qty-plus"></button>
                                                </div>
                                            </div>
                                            <div class="product-buttons">
                                                <a class="btn cart-btn btn-normal tooltip-top btn-cart" data-tippy-content="Add to cart"
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    <div class="creative-card creative-inner">
                                        <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link active bg-transparent" id="top-home-tab" data-bs-toggle="tab" href="#top-home" role="tab" aria-selected="true"><i class="icofont icofont-ui-home"></i>Description</a>
...
@includeIf('frontend.product._related_product')
