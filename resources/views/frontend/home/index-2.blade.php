...
@section('mainContent')
                            ...
                            <div class="product-box product-box2">
                                <div class="product-imgbox">
                                    ...
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/6.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                        ...
                        <div>
                            <div class="product-box product-box2">
                                <div class="product-imgbox">
                                    <div class="product-front">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/2.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/7.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
                        ...
                        <div>
                            <div class="product-box product-box2">
                                <div class="product-imgbox">
                                    <div class="product-front">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/3.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/8.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
                        ...
                        <div>
                            <div class="product-box product-box2">
                                <div class="product-imgbox">
                                    <div class="product-front">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/4.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/9.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
                        ...
                        <div>
                            <div class="product-box product-box2">
                                <div class="product-imgbox">
                                    <div class="product-front">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/5.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('frontend') }}/assets/images/mega-store/product/10.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button  class="tooltip-top  add-cartnoty" data-tippy-content="Add to cart">
            ...
            <div class="row collection-p4">
                <div class="col-md-4">
                    <div class="collection-banner-main p-center text-center p-top banner-16 banner-style7">
                        <div class="collection-img">
                            <img src="{{ asset('frontend') }}/assets/images/mega-store/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="collection-banner-main p-left text-center banner-13 banner-style7">
                                <div class="collection-img">
                                    <img src="{{ asset('frontend') }}/assets/images/mega-store/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                                </div>
                                <div class="collection-banner-contain ">
                                    <div>
                        ...
                        <div class="col-12">
                            <div class="collection-banner-main p-left text-center banner-13 banner-style7">
                                <div class="collection-img">
                                    <img src="{{ asset('frontend') }}/assets/images/mega-store/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                                </div>
                                <div class="collection-banner-contain ">
                                    <div>
                                        <h3>relex camera</h3>
                ...
                <div class="col-md-4">
                    <div class="collection-banner-main p-center p-top text-center banner-16 banner-style7">
                        <div class="collection-img">
                            <img src="{{ asset('frontend') }}/assets/images/mega-store/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                            <div>
                ...
                <div class="col-12 pr-0">
                    <div class="category-slide5two no-arrow">
                        <div>
                            <div class="category-box">
                                ...
                                <div class="category-detail">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Winter Jackets  </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> Office Blazer </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> sports watches </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> Professional Cap </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">printed t-shirt </a>
                                        </li>
                                    </ul>
                                    <a href="category-page(left-sidebar).html" class="btn btn-rounded btn-md btn-block">shop now</a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="category-box">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{ asset('frontend') }}/assets/images/mega-store/category/2.jpg" alt="category" class="img-fluid">
                                </a>
                                <div class="category-detail">
                                    <a href="category-page(left-sidebar).html">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Chesterfield Chair</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> Bunching Table</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> Sofa beds</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> Sleeper Sofas</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html"> Storage cabinets </a>
                                        </li>
                                    </ul>
                                    <a href="category-page(left-sidebar).html" class="btn btn-rounded btn-md btn-block">shop now</a>
                                </div>
                        ...
                        <div>
                            <div class="category-box">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{ asset('frontend') }}/assets/images/mega-store/category/3.jpg" alt="category" class="img-fluid">
                                </a>
                                <div class="category-detail">
                                    <a href="category-page(left-sidebar).html">
                                        <h2>letest electronics</h2>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Sony  oled TV </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Gaming Phone</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Asus Zenbook Pro</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">lg 21:9 Monitor </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Ceiling Fans</a>
                                        </li>
                                    </ul>
                                    <a href="category-page(left-sidebar).html" class="btn btn-rounded btn-md btn-block">shop now</a>
                                </div>
                        ...
                        <div>
                            <div class="category-box">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{ asset('frontend') }}/assets/images/mega-store/category/4.jpg" alt="category" class="img-fluid">
                                </a>
                                <div class="category-detail">
                                    <a href="category-page(left-sidebar).html">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Skin Concealer</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">eye makeup mascara</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Skin Cleansing Cream</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">organic cream </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">body loation</a>
                                        </li>
                                    </ul>
                                    <a href="category-page(left-sidebar).html" class="btn btn-rounded btn-md btn-block">shop now</a>
                                </div>
                        ...
                        <div>
                            <div class="category-box">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{ asset('frontend') }}/assets/images/mega-store/category/5.jpg" alt="category" class="img-fluid">
                                </a>
                                <div class="category-detail">
                                    <a href="category-page(left-sidebar).html">
                                        <h2>fresh grocery</h2>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="category-page(left-sidebar).html">White Pepper Powder </a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">vegetable & fruits</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Tomato sauce</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">Barbecue sauce</a>
                                        </li>
                                        <li>
                                            <a href="category-page(left-sidebar).html">fresh coffee powder</a>
                                        </li>
                                    </ul>
                                    <a href="category-page(left-sidebar).html" class="btn btn-rounded btn-md btn-block">shop now</a>
                                </div>
    ...
    <section class="sale-banenr banner-style2  section-big-mb-space">
        <img src="{{ asset('frontend') }}/assets/images/mega-store/sale-banner/1.jpg" alt="sale-banenr" class="img-fluid bg-img">
                    ...
                    <div class="hotdeal-slide3 no-arrow">
                        <div>
                            <div class="hotdeal-box">
                                <div class="img-wrapper">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{ asset('frontend') }}/assets/images/mega-store/hot-deal/1.jpg" alt="hot-deal" class="img-fluid bg-img">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="hotdeal-box">
                                <div class="img-wrapper">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{ asset('frontend') }}/assets/images/mega-store/hot-deal/2.jpg" alt="hot-deal" class="img-fluid bg-img">
                                    </a>
                                </div>
                                <div class="hotdeal-contain">
                                    <div>
                        ...
                        <div>
                            <div class="hotdeal-box">
                                <div class="img-wrapper">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{ asset('frontend') }}/assets/images/mega-store/hot-deal/3.jpg" alt="hot-deal" class="img-fluid bg-img">
                                    </a>
                                </div>
                                <div class="hotdeal-contain">
                                    <div>
    ...
    <section  class="tab-product-main  tab-second">
        <div class="tab-prodcut-contain">
            <ul class="tabs tab-title">
                ...
                <li class=""><a href="tab-2">furniture</a></li>
                ...
                <div class="col-12 p-0">
                    <div class="theme-tab product">
                        <div class="tab-content-cls ">
                            <div id="tab-1" class="tab-content active default product-block3">
                                <div class="col-12 ">
                                        ...
                                        <div>
                                            <div class="product-box3">
                                                <div class="media">
                                                    <div class="img-wrapper">
                                                        <a href="product-page(left-sidebar).html">
                                                            <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/mega-store/media-product/1.jpg" alt="product">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="product-detail">
                                                            ...
                                                            <h4>$70<span>$90</span></h4>
                                                            <a class="btn btn-rounded  btn-sm" href="product-page(left-sidebar).html" >shop now</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <div class="product-box3">
                                                <div class="media">
                                                    <div class="img-wrapper">
                                                        <a href="product-page(left-sidebar).html">
                                                            <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/mega-store/media-product/2.jpg" alt="product">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="product-detail">
                                        ...
                                        <div>
                                            <div class="product-box3">
                                                <div class="media">
                                                    <div class="img-wrapper">
                                                        <a href="product-page(left-sidebar).html">
                                                            <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/mega-store/media-product/3.jpg" alt="product">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="product-detail">
                                        ...
                                        <div>
                                            <div class="product-box3">
                                                <div class="media">
                                                    <div class="img-wrapper">
                                                        <a href="product-page(left-sidebar).html">
                                                            <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/mega-store/media-product/4.jpg" alt="product">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="product-detail">
                                        ...
                                        <div>
                                            <div class="product-box3">
                                                <div class="media">
                                                    <div class="img-wrapper">
                                                        <a href="product-page(left-sidebar).html">
                                                            <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/mega-store/media-product/5.jpg" alt="product">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="product-detail">
                                        ...
                                        <div>
                                            <div class="product-box3">
                                                <div class="media">
                                                    <div class="img-wrapper">
                                                        <a href="product-page(left-sidebar).html">
                                                            <img class="img-fluid" src="{{ asset('frontend') }}/assets/images/mega-store/media-product/6.jpg" alt="product">
                                                        </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="product-detail">
                            ...
                            <div id="tab-2" class="tab-content  product-block3">
                                <div class="col-12">
                                    <div class="product-slide-3 no-arrow">
                                        <div>
                                            <div class="product-box3">
                            ...
                            <div id="tab-3" class="tab-content  product-block3">
                                <div class="col-12">
                                    <div class="product-slide-3 no-arrow">
                                        <div>
                                            <div class="product-box3">
                            ...
                            <div id="tab-4" class="tab-content  product-block3">
                                <div class="col-12">
                                    <div class="product-slide-3 no-arrow">
                                        <div>
                                            <div class="product-box3">
                            ...
                            <div id="tab-5" class="tab-content  product-block3">
                                <div class="col-12">
                                    <div class="product-slide-3 no-arrow">
                                        <div>
                                            <div class="product-box3">
                    ...
                    <div class="testimonial-slide3 no-arrow">
                        <div>
                            <div class="testimonial-box">
                                ...
                                <div class="img-wrapper">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial/1.jpg" alt="testimonial" class="img-fluid" >
                                </div>
                                <ul>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div>
                            <div class="testimonial-box">
                                ...
                                <div class="img-wrapper">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial/2.jpg" alt="testimonial" class="img-fluid" >
                                </div>
                                <ul>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div>
                            <div class="testimonial-box">
                                ...
                                <div class="img-wrapper">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial/4.jpg" alt="testimonial" class="img-fluid" >
                                </div>
                                <ul>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div>
                            <div class="testimonial-box">
                                ...
                                <div class="img-wrapper">
                                    <img src="{{ asset('frontend') }}/assets/images/testimonial/3.jpg" alt="testimonial" class="img-fluid" >
                                </div>
                                <ul>
                                    <li><i class="fa fa-star"></i></li>
                                    <li><i class="fa fa-star"></i></li>
