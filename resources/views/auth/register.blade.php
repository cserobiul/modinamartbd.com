            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-8 offset-xl-4 offset-lg-3 offset-md-2">
                    <div class="theme-card">
                        ...
                        <h6 style="padding: 0 8%; text-align: justify">No need to register. When you <strong>purchase a product</strong>, automatically an account will be created and then you may login. <a
                                href="{{ route('shopPage') }}">Purchase Now</a></h6>
                        @error('email')
