...
@section('title', isset($pageTitle) ?  $pageTitle : 'Edit User')
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>{{ isset($pageTitle) ?  $pageTitle : 'Edit User' }}</strong></h2>
                        @canany(['user.all'])
                    ...
                    <div class="body" style="border: 2px solid #dddddd;">
                        <form id="form_advanced_validation" method="POST" action="{{ route('user.update',$user->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                             <div class="card">
                                <div class="body">
                                    <div class="row clearfix">
                                        <div class="col-md-6 pb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" value="{{ old('name',isset($user->name)?$user->name:null) }}"  class="form-control" placeholder="Type Full Name" autofocus required>
                                            </div>
                                            @error('name')
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-6 pb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="phone" value="{{ old('phone',isset($user->phone)?$user->phone:null) }}" class="form-control" placeholder="Type Phone No">
                                            </div>
                                            @error('phone')
                                            <div class="text-danger pt-2">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6 pb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="email" value="{{ old('email',isset($user->email)?$user->email:null) }}" class="form-control" placeholder="Email Address">
                                            </div>
                                            @error('email')
                                            <div class="text-danger pt-2">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-6">
                                            ...
                                            @if($user->profile_photo_path !=null)
                                                <br>
                                                <img src="{{ asset($user->profile_photo_path) }}" alt="Logo Image" class="rounded" style="width: 140px; margin-bottom: 15px !important;">
                                            @endif
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                            ...
                            <button type="submit" class="btn btn-raised btn-primary btn-round waves-effect">Update User</button>
                        </form>
                    </div>
                </div>
            </div>
