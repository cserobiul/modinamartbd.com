...
@section('title', isset($pageTitle) ?  $pageTitle : 'Online Customer Return Details')
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2> {{ isset($pageTitle) ?  $pageTitle : 'Online Customer Return Details' }}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="zmdi zmdi-home"></i> Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('customerReturnList') }}">Reports</a></li>
                    <li class="breadcrumb-item active">Online Customer Return Details</li>
                </ul>
        ...
        @canany(['report.all'])
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Online Customer Return Details</strong></h2>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable text-center">
                                        ...
                                        @foreach($productsReturn as $key => $return)
                                            <tr>
                                                <td>{{ $key+1 }}</td>
                                                <td>{{ $return->product->name ? $return->product->name : '-' }}</td>
                                                <td>{{ $return->quantity ? $return->quantity : '-' }}</td>
                                                <td>{{ $return->unit_price ? $return->unit_price : '-' }}</td>
