...
@section('title', isset($pageTitle) ?  $pageTitle : 'Online Customer')
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2> {{ isset($pageTitle) ?  $pageTitle : 'Online Customer Create' }}</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="zmdi zmdi-home"></i> Dashboard</a></li>
                        <li class="breadcrumb-item">Reports</li>
                        <li class="breadcrumb-item active">Online Customer List</li>
                    </ul>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="body" style="border: 2px solid #dddddd;">
                            ...
                            @else
                                <div class="col-md-6">
                                    <h6 class="pt-3 text-danger"> No Online Customers Found... </h6>
                                </div>
                            @endif
                        </div>
                    </div>
