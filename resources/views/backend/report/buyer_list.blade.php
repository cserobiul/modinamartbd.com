                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="body" style="border: 2px solid #dddddd;">
                                    ...
                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                        ...
                                        @foreach($customers as $key => $customer)
                                            <tr class="text-center">
                                                <td>{{ $key+1 }}</td>
                                                <td>
                                                    <a href="{{ route('buyer.due.details',$customer->id) }}">
                                                        {{ \App\Models\Settings::unicodeName($customer->name) }}
                                                    </a>
                                                </td>
                            ...
                            @else
                                <div class="col-md-6">
                                    <h6 class="pt-3 text-danger"> No Customers Found...</h6>
                                </div>
                            @endif
                        </div>
                    </div>
