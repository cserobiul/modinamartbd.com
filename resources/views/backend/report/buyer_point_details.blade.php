...
@section('title', isset($pageTitle) ?  $pageTitle : 'Customer Point Details')
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2> {{ isset($pageTitle) ?  $pageTitle : 'Customer Point Details' }}</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="zmdi zmdi-home"></i>
                                Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('buyerPoint') }}">Customers Points</a></li>
                        <li class="breadcrumb-item active">Customer Point Details</li>
                    </ul>
            ...
            @canany(['report.show'])
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Customer Point Details</strong></h2> <br>
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th colspan="3">Customer
                                                Name: {{ \App\Models\Settings::unicodeName($buyerDetails->name) }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>Total Earn
                                                Point: {{ \App\Models\Reward::buyerEarnPoints($buyerDetails->id) }}
                                            </th>
                                            <th>Total Withdraw
                                                Point: {{ \App\Models\Reward::buyerWithdrawPoints($buyerDetails->id) }}
                                            </th>
                                            <th>Total Remaining
                                                Point: {{ \App\Models\Reward::buyerRemainingPoints($buyerDetails->id) }}
                                            </th>
                                        </tr>
                            ...
                            {{-- Point History--}}
                            <h5><strong>Point History</strong></h5>
