...
@section('title', isset($pageTitle) ?  $pageTitle : 'All Customer Return List')
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>All {{ isset($pageTitle) ?  $pageTitle : 'Customer Return List' }}</h2>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="zmdi zmdi-home"></i> Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('buyerReturnList') }}">Reports</a></li>
                    <li class="breadcrumb-item active">All Customer Return List</li>
                </ul>
        ...
        @canany(['report.all'])
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Customer Return List</strong></h2>
                        </div>
                        <div class="body" style="border: 2px solid #dddddd;">
                            ...
                            @else
                                <div class="col-md-6">
                                    <h6 class="pt-3 text-danger"> No Customer Return Found... </h6>
                                </div>
                            @endif
                        </div>
                    </div>
