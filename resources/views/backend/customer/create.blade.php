        ...
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Customer List Customer</li>
                </ul>
    ...
    <div class="container-fluid">
        @canany(['customer.create'])
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>New <strong>{{ isset($pageTitle) ?  $pageTitle : 'New Customer' }}</strong></h2>
                    </div>
                    @include('backend.layouts._alert')
                    <form id="form_advanced_validation" method="POST" action="{{ route('customer.store') }}" enctype="multipart/form-data">
                        @csrf
                         <div class="body" style="border: 2px solid #dddddd;">
                                <div class="row clearfix">
                                    <div class="col-md-6 pb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}"  class="form-control" placeholder="Type Customer Full Name" autofocus required>
                                        </div>
                                        @error('name')
                                ...
                                <div class="row clearfix">
                                    <div class="col-md-12 pb-2">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="address" id="address" value="{{ old('address') }}"  class="form-control" placeholder="Type customer address">
                                        </div>
                                        @error('address')
                                        <div class="text-danger pt-2">{{ $message }}</div>
                                        @enderror
                                ...
                                <button type="submit" class="btn btn-raised btn-primary btn-round waves-effect">Create Customer</button>
                            </div>
                    </form>
                </div>
            </div>
