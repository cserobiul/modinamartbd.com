...
@section('buyerProductReturn','active')
        ...
        @canany(['accounts.create'])
            <div class="row clearfix">
                ...
                <div class="col-sm-12 beforeReturnProduct" style="display: none">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Successfully Customer Product Return</strong></h2>
                        </div>
                        <div class="body">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4 pb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="invoice_no" id="invoice_no" value="{{ old('invoice_no',$sale->invoice_no) }}" class="form-control" placeholder="e.g.: 21 or OID-1000021" readonly>
                                ...
                                <div class="col-md-4 pb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name',ucwords($buyer->name).' - '.$buyer->phone) }}" class="form-control" placeholder="" readonly>
                                    </div>
                                    @error('customer_name')
                                    <div class="text-danger pt-2">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4 pb-2 payment_method_view">
                                ...
                                <div class="col-md-4 pb-2 transaction_id_view">
                            ...
                            <button type="submit" cus-url="{{ route('buyerProductReturnProcessStore') }}" class="btn btn-raised btn-primary btn-round waves-effect buyerReturnProductPlace">Return Product Place</button>
                        </div>
                    </div>
                </div>
...
{{--                            <h2><strong>Product Search...</strong></h2>--}}
                         ...
                         <div class="body" style="border: 2px solid #dddddd;">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3 pb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="quantity" max="" min="1" id="quantity" value="{{ old('quantity',1) }}"  class="form-control" placeholder="e.g. 10" required>
                                    </div>
                                    @error('quantity')
                                    <div class="text-danger pt-2">{{ $message }}</div>
                                    @enderror
                            ...
                            <a class="btn btn-raised btn-primary btn-round waves-effect cus- buyerReturnCart">Add to Return Cart</a>
                        </div>
                    </div>
                </div>
...
<script src="{{ asset('assets/js/buyer_return_cart.js') }}"></script>
<script>
